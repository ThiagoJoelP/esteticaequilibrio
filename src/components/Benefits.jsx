...
const items = [
  { icon: '⚙️', title: 'Tecnología avanzada', desc: 'Equipos de última generación para tratamientos seguros y efectivos.' },
  { icon: '✨', title: 'Resultados visibles', desc: 'Notarás cambios reales desde tu primera sesión de tratamiento.' },
  { icon: '🫂', title: 'Atención personalizada', desc: 'Cada plan se diseña a medida según tus objetivos y necesidades.' },
  { icon: '🌿', title: 'Ambiente profesional', desc: 'Un espacio pensado para tu relajación, confort y bienestar.' },
]
